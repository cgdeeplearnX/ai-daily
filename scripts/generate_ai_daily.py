...
DEFAULT_FEEDS = [
    ...
    ("NVIDIA Generative AI Blog", "https://developer.nvidia.com/blog/category/generative-ai/feed/"),
    ("NVIDIA Deep Learning Blog", "https://developer.nvidia.com/blog/category/deep-learning/feed/"),
